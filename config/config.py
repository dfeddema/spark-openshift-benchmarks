...
SPARK_JOB_TEMPLATE="oshinko-pyspark-job"  

DOCKER_IMAGE="172.30.100.159:5000/perf-testing-d/mllibpython"
SPARK_OPTIONS="--executor-memory 200G --conf spark.default.parallelism=40 --conf spark.python.worker.memory=190g"
OSHINKO_SPARK_DRIVER_CONFIG="oshinko-spark-driver-config"
OSHINKO_DEL_CLUSTER="true"
OSHINKO_CLUSTER_NM="dianeclusterosbs"
COMPLETIONS="1"

PBENCH_HOME="/opt/pbench-agent/bench-scripts/" 
SPARKPERF_RUNDIR="/root/diane/spark-on-openshift-benchmarks/" 
